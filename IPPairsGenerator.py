class IPPairsGenerator():
    ...
    def getIPPairs(self, data, file_path):
        ...
        if(self.is_icmp(data)):
            ...
            key1 = (self.getNegativeFlag(file_path) + src_ip, self.getNegativeFlag(file_path) + dst_ip)
            key2 = (self.getNegativeFlag(file_path) + dst_ip, self.getNegativeFlag(file_path) + src_ip)
